<%@ Page Language="C#" MasterPageFile="~/MasterMain.master" AutoEventWireup="true" CodeFile="Role-List.aspx.cs" Inherits="Role_List" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        ...
                        <a id="btnGrant" runat="server" href="#" class="btn btn-sm btn-warning text-white">
                            <i class="fa fa-toggle-on"></i> <asp:Literal ID="ltrGrant" runat="server" Text="授權"></asp:Literal>
                        </a>
